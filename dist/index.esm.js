...
var spinStyle = css(templateObject_2$B || (templateObject_2$B = __makeTemplateObject(["\n  animation: ", " 2s linear infinite;\n"], ["\n  animation: ", " 2s linear infinite;\n"])), rotate$1);
...
var Icon$1h = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default.createElement("image", { href: "/assets/images/logo.png", width: 32, height: 32 })));
};
...
var Logo$2 = function (_a) {
    ...
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 160 26" }, props),
        React__default.createElement("image", { href: "/assets/images/logo-desktop.png", width: 160, height: 26 })));
};
...
var Icon$Z = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default.createElement("image", { href: "/assets/images/token-mloky.png", width: 90, height: 90 })));
};
...
var Details = styled.div(templateObject_2$A || (templateObject_2$A = __makeTemplateObject(["\n  flex: 1;\n  padding-bottom: 12px;\n  padding-left: 12px;\n  padding-right: ", ";\n  padding-top: 12px;\n"], ["\n  flex: 1;\n  padding-bottom: 12px;\n  padding-left: 12px;\n  padding-right: ", ";\n  padding-top: 12px;\n"])), function (_a) {
...
var SwitchUnitsButton = styled(IconButton)(templateObject_1$12 || (templateObject_1$12 = __makeTemplateObject(["\n  width: 16px;\n"], ["\n  width: 16px;\n"])));
var UnitContainer = styled(Text)(templateObject_2$z || (templateObject_2$z = __makeTemplateObject(["\n  margin-left: 4px;\n  text-align: right;\n  color: ", ";\n  white-space: nowrap;\n"], ["\n  margin-left: 4px;\n  text-align: right;\n  color: ", ";\n  white-space: nowrap;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.textSubtle;
});
...
var BalanceInputLottery = function (_a) {
    ...
    return (React__default.createElement(StyledBalanceInput, __assign({ isWarning: isWarning }, props),
        React__default.createElement(Flex, { justifyContent: "flex-end" },
            React__default.createElement(Box, null,
                React__default.createElement(Flex, { alignItems: "center" },
                    React__default.createElement(StyledInput$1, __assign({ pattern: "^[0-9]*[.,]?[0-9]{0," + decimals + "}$", inputMode: "decimal", min: "0", value: value, onChange: handleOnChange, placeholder: placeholder, ref: innerRef }, inputProps, { placeholderColor: '#E24717', style: { color: '#E24717' } })),
                    unit && React__default.createElement(UnitContainer, null, unit)),
                currencyValue && (React__default.createElement(Text, { fontSize: "12px", textAlign: "right", color: "primary" }, currencyValue))),
            switchEditingUnits && (React__default.createElement(Flex, { alignItems: "center", pl: "12px" },
                React__default.createElement(SwitchUnitsButton, { scale: "sm", variant: "primary", onClick: switchEditingUnits },
                    React__default.createElement(Icon$w, { color: "primary" })))))));
};
...
var StyledBreadcrumbs = styled.ul(templateObject_2$y || (templateObject_2$y = __makeTemplateObject(["\n  align-items: center;\n  display: flex;\n  flex-wrap: wrap;\n  list-style-type: none;\n\n  a {\n    color: ", ";\n\n    &:hover {\n      color: ", ";\n    }\n  }\n\n  ", "\n"], ["\n  align-items: center;\n  display: flex;\n  flex-wrap: wrap;\n  list-style-type: none;\n\n  a {\n    color: ", ";\n\n    &:hover {\n      color: ", ";\n    }\n  }\n\n  ", "\n"])), function (_a) {
    var theme = _a.theme;
...
var InactiveButton$1 = styled(Button)(templateObject_1$$ || (templateObject_1$$ = __makeTemplateObject(["\n  background-color: transparent;\n  color: ", ";\n  &:hover:not(:disabled):not(:active) {\n    background-color: transparent;\n  };\n  font-size: 15px;\n  height: 35px;\n"], ["\n  background-color: transparent;\n  color: ", ";\n  &:hover:not(:disabled):not(:active) {\n    background-color: transparent;\n  };\n  font-size: 15px;\n  height: 35px;\n"])), function (_a) {
    var theme = _a.theme, variant = _a.variant;
    return (variant === variants$6.PRIMARY ? theme.colors.primary : theme.colors.textSubtle);
});
var ActiveButton$1 = styled(Button)(templateObject_2$x || (templateObject_2$x = __makeTemplateObject(["\n  font-size: 15px;\n  height: 35px;\n"], ["\n  font-size: 15px;\n  height: 35px;\n"])));
var ButtonMenuItem = function (_a) {
    var _b = _a.isActive, isActive = _b === void 0 ? false : _b; _a.variant; var as = _a.as, props = __rest(_a, ["isActive", "variant", "as"]);
    if (!isActive) {
        return React__default.createElement(InactiveButton$1, __assign({ forwardedAs: as, variant: variants$6.TEXT }, props));
    }
    return React__default.createElement(ActiveButton$1, __assign({ forwardedAs: as, variant: variants$6.PRIMARY }, props));
};
...
var ActiveButton = styled(Button)(templateObject_2$w || (templateObject_2$w = __makeTemplateObject(["\n  font-size: 15px;\n  height: 35px;\n  color: ", ";\n  background: ", ";\n"], ["\n  font-size: 15px;\n  height: 35px;\n  color: ", ";\n  background: ", ";\n"])), function (_a) {
    var theme = _a.theme, variant = _a.variant;
    return (variant ? (variant === variants$6.PRIMARY ? theme.colors.primary : variant) : theme.colors.textSubtle);
}, function (_a) {
...
var LotteryMenuItem = function (_a) {
    ...
    if (!isActive) {
        return React__default.createElement(InactiveButton, __assign({ forwardedAs: as, variant: variants$6.TEXT, inActiveBackground: inActiveBackground }, props));
    }
    return React__default.createElement(ActiveButton, __assign({ forwardedAs: as, variant: variants$6.PRIMARY, activeBackground: activeBackground }, props));
};
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default.createElement(PriceLink, { href: "https://app.luchowswap.com/swap?outputCurrency=0xF71E950758310faF9f7D51C4F4250C7546086C1f", target: "_blank" },
        React__default.createElement(Icon$Z, { width: "24px", mr: "8px" }),
        React__default.createElement(Text, { color: color, bold: true },
            "$", "" + cakePriceUsd.toFixed(3)))) : (React__default.createElement(Skeleton, { width: 80, height: 24 }));
};
...
var StyledBunnyPlaceholder = styled(Icon$1_)(templateObject_2$p || (templateObject_2$p = __makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n"], ["\n  height: 100%;\n  width: 100%;\n"])));
...
var KroimSubMenuContainer = styled.div(templateObject_1$o || (templateObject_1$o = __makeTemplateObject(["\n  ", " {\n    ", ";\n  }\n  position: absolute;\n  display: flex;\n  top: -20px;\n"], ["\n  ", " {\n    ", ";\n  }\n  position: absolute;\n  display: flex;\n  top: -20px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
}, function (_a) {
    var $isMobileOnly = _a.$isMobileOnly;
...
var KroimSubMenuBox = styled(Box)(templateObject_2$f || (templateObject_2$f = __makeTemplateObject(["\n  padding: 0 32px 0 12px;\n  background: ", ";\n  border-top-left-radius: 24px;\n  border-bottom-right-radius: 24px;\n  margin: 0 -12px;\n  &:last-child{\n    padding: 0 12px;\n  }\n"], ["\n  padding: 0 32px 0 12px;\n  background: ", ";\n  border-top-left-radius: 24px;\n  border-bottom-right-radius: 24px;\n  margin: 0 -12px;\n  &:last-child{\n    padding: 0 12px;\n  }\n"])), function (_a) {
    var isActive = _a.isActive;
...
var SubMenuItems = function (_a) {
    ...
    return (React__default.createElement(StyledSubMenuItems, __assign({ justifyContent: [isMobileOnly ? "flex-end" : "start", null, "center"] }, props, { pl: ["12px", null, "0px"], "$isMobileOnly": isMobileOnly }),
        React__default.createElement(KroimSubMenuContainer, { "$isMobileOnly": isMobileOnly }, items.map(function (_a) {
            var label = _a.label, href = _a.href, iconName = _a.iconName;
            return label && (React__default.createElement(KroimSubMenuBox, { key: label, isActive: href === activeItem },
...
var ModalCloseButton = function (_a) {
    ...
    return (React__default.createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
        React__default.createElement(Icon$1M, { color: "text" })));
};
        ...
        React__default.createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            ...
            React__default.createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                ...
                React__default.createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default.createElement(Button, { as: "a", href: "https://app.luchowswap.com/swap?outputCurrency=0xe4e8e6878718bfe533702D4a6571Eb74D79b0915", target: "_blank", scale: "sm", endIcon: React__default.createElement(Icon$27, { color: lightColors.backgroundAlt }) }, buyCakeLabel))))));
};
...
var Menu$1 = function (_a) {
    ...
    return (React__default.createElement(Wrapper, null,
        React__default.createElement(FixedContainer, { showMenu: showMenu, height: totalTopMenuHeight },
            ...
            React__default.createElement(Box, { maxWidth: "1200px", mx: "auto" },
